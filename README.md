...
The PianoVAM clip in `assets/video/transfer_vam_*` is derived from the PianoVAM dataset
(Kim et al., https://huggingface.co/datasets/PianoVAM/PianoVAM_v1) and is shared under CC BY-NC-SA 4.0.
